...
const daysFromNow = (days, extraHours = 0) => new Date(Date.now() + days * 86400000 + extraHours * 3600000);
async function main() {
    ...
    const firm1Password = await bcryptjs_1.default.hash('firm123', 10);
    ...
    const firm2Password = await bcryptjs_1.default.hash('firm456', 10);
