...
import { closeKassa, createKassaDesk, createPaymentCard, deletePaymentCard, getKassaDay, getKassaHistory, listKassaDesks, listPaymentCards, openKassa, reopenKassa, updateKassaDesk, updatePaymentCard } from '../controllers/kassa.controller';
